...
class LanguagePack:
    ...
    coarticulation_fade_into_consonants: bool = False
    coarticulation_steady_state: bool = False
    coarticulation_trans_in_ms: float = 35.0
    coarticulation_trans_out_ms: float = 40.0
    svarabhakti_inherit_enabled: bool = False
    svarabhakti_vowel_weight: float = 0.8
    svarabhakti_duration_scale: float = 0.5
    svarabhakti_amp_scale: float = 0.85
    svarabhakti_tap_blend: float = 0.0
    svarabhakti_tap_dip: float = 1.0
    ...
    coda_noise_taper_pre_gain: float = 0.0
    coda_noise_taper_early_fric_scale: float = 0.45
    coda_noise_taper_early_asp_amp: float = 0.04
    coda_noise_taper_late_fric_scale: float = 0.0
    coda_noise_taper_late_asp_amp: float = 0.0
...
def _merge_settings(lp: LanguagePack, s: dict):
    ...
    lp.coarticulation_steady_state = gb("coarticulationSteadyState", lp.coarticulation_steady_state)
    lp.coarticulation_trans_in_ms = gn("coarticulationTransInMs", lp.coarticulation_trans_in_ms)
    lp.coarticulation_trans_out_ms = gn("coarticulationTransOutMs", lp.coarticulation_trans_out_ms)
    lp.svarabhakti_inherit_enabled = gb("svarabhaktiInheritEnabled", lp.svarabhakti_inherit_enabled)
    lp.svarabhakti_vowel_weight = gn("svarabhaktiVowelWeight", lp.svarabhakti_vowel_weight)
    lp.svarabhakti_duration_scale = gn("svarabhaktiDurationScale", lp.svarabhakti_duration_scale)
    lp.svarabhakti_amp_scale = gn("svarabhaktiAmpScale", lp.svarabhakti_amp_scale)
    lp.svarabhakti_tap_blend = gn("svarabhaktiTapBlend", lp.svarabhakti_tap_blend)
    lp.svarabhakti_tap_dip = gn("svarabhaktiTapDip", lp.svarabhakti_tap_dip)
