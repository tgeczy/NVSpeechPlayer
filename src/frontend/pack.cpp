...
getNum("primaryStressDiv", lp.primaryStressDiv);
  ...
  getBool("coarticulationSteadyState", lp.coarticulationSteadyState);
  getNum("coarticulationTransInMs", lp.coarticulationTransInMs);
  getNum("coarticulationTransOutMs", lp.coarticulationTransOutMs);
  getBool("svarabhaktiInheritEnabled", lp.svarabhaktiInheritEnabled);
  getNum("svarabhaktiVowelWeight", lp.svarabhaktiVowelWeight);
  getNum("svarabhaktiDurationScale", lp.svarabhaktiDurationScale);
  getNum("svarabhaktiAmpScale", lp.svarabhaktiAmpScale);
  getNum("svarabhaktiTapBlend", lp.svarabhaktiTapBlend);
  getNum("svarabhaktiTapDip", lp.svarabhaktiTapDip);
